package com.WebServlet.Controllers;
...
import com.WebServlet.Beans.UserAccount;
import com.WebServlet.Connection.*;
import com.WebServlet.Dto.*;
...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// Và chuyển hướng sang trang userInfo.
			...
			System.out.println(request.getContextPath()+"/userInfo"+" login sucessfull");
